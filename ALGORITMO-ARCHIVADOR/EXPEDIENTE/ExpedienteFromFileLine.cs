...
using MesaPartesCajamarca.Expediente.ToFileLine;
using System;
...
namespace MesaPartesCajamarca.Expediente.FromFileLine
{
    public class ExpedienteFromFileLine : ExpedienteToFileLine
    {
        public static ExpedienteFromFileLine FromFileLine(string line)
        {
            ...
            return new ExpedienteFromFileLine
            {
                Codigo = parts[0],
                DniRuc = parts[1],
                Nombres = parts[2],
